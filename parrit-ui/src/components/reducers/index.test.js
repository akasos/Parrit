...
describe('Reducers', () => {
    ...
    describe('listOfPairingBoards Reducer', () => {
        ...
        it('should remove a teammate from a pairingBoard', () => {
            const action = {type: actionTypes.REMOVE_TEAMMATE_FROM_PAIRING_BOARD, payload: { teammateId: 1, pairingBoardId: 2 }};
            const actual = [{id: 2, title: "Area 51", teammates: [{id: 1, name: "Austin", pairingBoard: 2 }]}];
            const expected = [{id: 2, title: "Area 51", teammates: []}];
            expect(listOfPairingBoards(actual,action)).toEqual(expected);
